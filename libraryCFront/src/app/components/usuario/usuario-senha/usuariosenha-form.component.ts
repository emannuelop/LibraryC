...
@Component({
  ...
  templateUrl: './usuariosenha-form.component.html',
  styleUrl: './usuariosenha-form.component.css'
})
export class UsuarioSenhaFormComponent implements OnInit {
  ...
  salvar() {
    ...
    if (this.formGroup.valid) {
      ...
      console.log(usuario);
      if (usuario != null) {
        this.usuarioService.alterarSenha(usuario.senhaAtual, usuario.senhaNova).subscribe({
